...
#-Criação de código reutilizável que pode ser compartilhado entre vários casos de teste
#-Reduzindo a quantidade de código duplicado
#-Se a interface do usuário mudar, a correção precisará de alterações em apenas um lugar
